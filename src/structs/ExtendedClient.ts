import { ApplicationCommandDataResolvable, Client, ClientEvents, Collection, IntentsBitField, BitFieldResolvable, GatewayIntentsString, Partials } from "discord.js";
...
export class ExtendedClient extends Client {
    ...
    private registerCommands(commands: Array<ApplicationCommandDataResolvable>) {
        this.application?.commands.set(commands)
            ...
            .catch(error => {
                console.log(`❌ An error occurred while trying to set the slash command (/) \n${error}`);
            })
    }
